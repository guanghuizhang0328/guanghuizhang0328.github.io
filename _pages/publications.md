...
* **Matlab script code:** Four different techniqes are used to extract N2 of interest from 20 participants and P2 from 17 participants ([Download Matlab script codes](../_publications/Code scripts Online.rar) & [Read me](../_publications/Read_me_Emotional_Lu_2017_codes_for_EEG_ERP_Processing.pdf)). (a) 'Conventional time-domain analysis': P2 and N2 are quantified from preprocessed ERP data directly at group analysis; (b) 'Trial-averaged group PCA': Both ERP components are measured from the averaged ERP data of all subject simultaneously by using temporal principal component analysis and Promax rotation. 
